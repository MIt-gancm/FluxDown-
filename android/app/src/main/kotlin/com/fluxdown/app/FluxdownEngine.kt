 ...
 * 并在其 [io.flutter.embedding.android.FlutterActivity.onStart] 里经 [cacheIfAbsent]
 * 把引擎缓存；后续 Activity 通过 override [io.flutter.embedding.android.FlutterActivity.getCachedEngineId]
 * 复用引擎而不再创建。缓存/绑定统一放在 onStart，避免受 configureFlutterEngine
